...
# REVISAR 
# def listar_empleados(datos_empleados: dict):
#     """
#     Lista los empleados.
...
#     """
#     for i, empleado in enumerate(util.datos_empleados["empleados"]):
...
#     listar_empleados()
#     asiste = input(
#                     "\nIngrese el nombre o numero del empleado (o 0 para volver): "
#                 )
#     if asiste == "0":
#         return None, None
#     limpiar_pantalla()
